...
## Environments
- Preview: https://main--mrugesh-mmsg-demo--aemysites.aem.page/
- Live: https://main--mrugesh-mmsg-demo--aemysites.aem.live/
- Block Library: https://main--mrugesh-mmsg-demo--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `mrugesh-mmsg-demo` directory in your favorite IDE and start coding :)
